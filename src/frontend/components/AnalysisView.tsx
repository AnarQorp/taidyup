...
function EvidenceCard({ evidence }: { evidence: Evidence }) {
  ...
  return <article className="rounded-md border border-[#1A1D20]/15 bg-white p-4 text-xs shadow-2xs hover:border-[#1E50C8]/40 transition-all" data-source-type={evidence.sourceType}>
    ...
    <dl className="grid grid-cols-[6rem_1fr] gap-x-3 gap-y-1.5">
      ...
      <dt className="text-[#5C6068] font-medium">Strength</dt><dd className="font-mono text-[#0D7490] font-semibold">{evidence.strength}</dd>
...
export function AnalysisView({ state }: { state: AnalysisUiState }) {
  ...
  return <div className="space-y-6" data-ui-state="success">
    ...
    <details className="dark-proof-drawer rounded-xl p-5 shadow-xl">
      ...
      <p className="mt-3 text-xs text-[#9CA3AF]">Declared, local observed, and explicitly inspected CONNECTED evidence remain distinguishable.</p>
